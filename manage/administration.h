...
public:
    ...
    void publicWidget(QWidget *widgetName);
    ...
    //管理员登陆界面初始化容器;
    QWidget *widgeName, *adminWidget;
    //添加学生信息; 管理学生信息（写、改、删、查）; 删除的学生信息暂存站
    QWidget *addStudentWidget, *manageStudengWidget, *studentDustbinWidget;
    QWidget *addBlooksWidget;
    QWidget *neatenBooksWidget, *clearSanitationWidget, *informationWidget;
    QWidget *session;       //定义一个空的全局变量，存放每一个当前打开的容器，以便下一个容器关闭当前
    ...
    //添加学生信息; 管理学生信息（写、改、删、查）; 删除的学生信息暂存站
//    QScrollArea  *manageStudengScroll, *studentDustbinScroll;
